...
<head>
    ...
    <title>Urbania API Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-reset-password">POST api/v1/auth/reset-password</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-verify-email">
                                <a href="#endpoints-POSTapi-v1-auth-verify-email">POST api/v1/auth/verify-email</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-resend-verification">POST api/v1/auth/resend-verification</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-mfa-setup">
                                <a href="#endpoints-POSTapi-v1-auth-mfa-setup">POST api/v1/auth/mfa/setup</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-mfa-enable">
                                <a href="#endpoints-POSTapi-v1-auth-mfa-enable">POST api/v1/auth/mfa/enable</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-mfa-disable">
                                <a href="#endpoints-POSTapi-v1-auth-mfa-disable">POST api/v1/auth/mfa/disable</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-mfa-backup-codes">
                                <a href="#endpoints-POSTapi-v1-auth-mfa-backup-codes">POST api/v1/auth/mfa/backup-codes</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-auth-sessions">
                                <a href="#endpoints-GETapi-v1-auth-sessions">GET api/v1/auth/sessions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-auth-sessions">
                                <a href="#endpoints-DELETEapi-v1-auth-sessions">DELETE api/v1/auth/sessions</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-auth-sessions--sessionId-">
                                <a href="#endpoints-DELETEapi-v1-auth-sessions--sessionId-">DELETE api/v1/auth/sessions/{sessionId}</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-mfa-verify">POST api/v1/auth/mfa/verify</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-mfa-verify-backup">
                                <a href="#endpoints-POSTapi-v1-auth-mfa-verify-backup">POST api/v1/auth/mfa/verify-backup</a>
                            </li>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Must not be greater than 128 characters. Example: <code>+-0pBNvYgxwmi/#iw</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Must not be greater than 128 characters. Example: <code>-0pBNvYgxw</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^[0-9+-()\s]+$/. Must not be greater than 20 characters. Example: <code>ngzmiyvdljnikhwa</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="unit"                data-endpoint="POSTapi-v1-auth-register"
               value="y"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Must not be greater than 128 characters. Example: <code>]|{+-0pBNvYg</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password_confirmation</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>The value and <code>password</code> must match. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-verify-email">POST api/v1/auth/verify-email</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="POSTapi-v1-auth-verify-email"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
x-trace-id: 019ee5a3-5caf-718c-b863-f609adf0e808
...
<code class="language-json" style="max-height: 300px;">{
    &quot;error&quot;: {
        ...
        &quot;trace_id&quot;: &quot;019ee5a3-5caf-718c-b863-f609adf0e808&quot;
    }
}</code>
 </pre>
    </span>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PATCHapi-v1-auth-me"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PATCHapi-v1-auth-me"
               value="+6425593142"
               data-component="body">
    <br>
<p>Must match the regex /^+?[0-9]{7,15}$/. Example: <code>+6425593142</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="avatar"                data-endpoint="PATCHapi-v1-auth-me"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Must not be greater than 128 characters. Example: <code>n</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The value and <code>new_password</code> must match. Example: <code>architecto</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-resend-verification">POST api/v1/auth/resend-verification</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-mfa-setup">POST api/v1/auth/mfa/setup</h2>
...
<span id="example-requests-POSTapi-v1-auth-mfa-setup">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-auth-mfa-setup">
</span>
<span id="execution-results-POSTapi-v1-auth-mfa-setup" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-mfa-setup"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-mfa-setup"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-mfa-setup" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-mfa-setup">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-mfa-setup" data-method="POST"
      data-path="api/v1/auth/mfa/setup"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-mfa-setup', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-mfa-setup"
                    onclick="tryItOut('POSTapi-v1-auth-mfa-setup');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-mfa-setup"
                    onclick="cancelTryOut('POSTapi-v1-auth-mfa-setup');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-mfa-setup"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/mfa/setup</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-mfa-setup"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-mfa-setup"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-mfa-enable">POST api/v1/auth/mfa/enable</h2>
...
<span id="example-requests-POSTapi-v1-auth-mfa-enable">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/auth/mfa/enable" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"code\": \"bngzmi\"
...
<span id="example-responses-POSTapi-v1-auth-mfa-enable">
</span>
<span id="execution-results-POSTapi-v1-auth-mfa-enable" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-mfa-enable"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-mfa-enable"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-mfa-enable" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-mfa-enable">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-mfa-enable" data-method="POST"
      data-path="api/v1/auth/mfa/enable"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-mfa-enable', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-mfa-enable"
                    onclick="tryItOut('POSTapi-v1-auth-mfa-enable');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-mfa-enable"
                    onclick="cancelTryOut('POSTapi-v1-auth-mfa-enable');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-mfa-enable"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/mfa/enable</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-mfa-enable"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-mfa-enable"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-auth-mfa-enable"
               value="bngzmi"
               data-component="body">
    <br>
<p>Must be 6 characters. Example: <code>bngzmi</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-mfa-disable">POST api/v1/auth/mfa/disable</h2>
...
<span id="example-requests-POSTapi-v1-auth-mfa-disable">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-auth-mfa-disable">
</span>
<span id="execution-results-POSTapi-v1-auth-mfa-disable" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-mfa-disable"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-mfa-disable"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-mfa-disable" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-mfa-disable">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-mfa-disable" data-method="POST"
      data-path="api/v1/auth/mfa/disable"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-mfa-disable', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-mfa-disable"
                    onclick="tryItOut('POSTapi-v1-auth-mfa-disable');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-mfa-disable"
                    onclick="cancelTryOut('POSTapi-v1-auth-mfa-disable');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-mfa-disable"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/mfa/disable</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-mfa-disable"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-mfa-disable"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-v1-auth-mfa-disable"
               value="|]|{+-"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-auth-mfa-disable"
               value="vdljni"
               data-component="body">
    <br>
<p>Must be 6 characters. Example: <code>vdljni</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-v1-auth-mfa-backup-codes">POST api/v1/auth/mfa/backup-codes</h2>
...
<span id="example-requests-POSTapi-v1-auth-mfa-backup-codes">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/auth/mfa/backup-codes" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-auth-mfa-backup-codes">
</span>
<span id="execution-results-POSTapi-v1-auth-mfa-backup-codes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-mfa-backup-codes"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-mfa-backup-codes"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-mfa-backup-codes" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-mfa-backup-codes">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-mfa-backup-codes" data-method="POST"
      data-path="api/v1/auth/mfa/backup-codes"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-mfa-backup-codes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-mfa-backup-codes"
                    onclick="tryItOut('POSTapi-v1-auth-mfa-backup-codes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-mfa-backup-codes"
                    onclick="cancelTryOut('POSTapi-v1-auth-mfa-backup-codes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-mfa-backup-codes"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/mfa/backup-codes</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-mfa-backup-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-mfa-backup-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-auth-sessions">GET api/v1/auth/sessions</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/auth/sessions" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
x-trace-id: 019ee5a3-5f9c-722c-ad72-8063ba5fa94a
access-control-allow-origin: *
 </code></pre></details>         <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;error&quot;: {
        &quot;code&quot;: &quot;TOKEN_INVALID&quot;,
        &quot;message&quot;: &quot;Authorization token is required&quot;,
        &quot;trace_id&quot;: &quot;019ee5a3-5f9c-722c-ad72-8063ba5fa94a&quot;
    }
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-auth-sessions">DELETE api/v1/auth/sessions</h2>
...
<span id="example-requests-DELETEapi-v1-auth-sessions">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-auth-sessions">
</span>
<span id="execution-results-DELETEapi-v1-auth-sessions" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-auth-sessions"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-auth-sessions"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-auth-sessions" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-auth-sessions">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-auth-sessions" data-method="DELETE"
      data-path="api/v1/auth/sessions"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-auth-sessions', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-auth-sessions"
                    onclick="tryItOut('DELETEapi-v1-auth-sessions');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-auth-sessions"
                    onclick="cancelTryOut('DELETEapi-v1-auth-sessions');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-auth-sessions"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-auth-sessions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-auth-sessions"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-auth-sessions--sessionId-">DELETE api/v1/auth/sessions/{sessionId}</h2>
...
<span id="example-requests-DELETEapi-v1-auth-sessions--sessionId-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request DELETE \
    "http://localhost:8080/api/v1/auth/sessions/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-DELETEapi-v1-auth-sessions--sessionId-">
</span>
<span id="execution-results-DELETEapi-v1-auth-sessions--sessionId-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-auth-sessions--sessionId-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-auth-sessions--sessionId-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-auth-sessions--sessionId-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-auth-sessions--sessionId-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-auth-sessions--sessionId-" data-method="DELETE"
      data-path="api/v1/auth/sessions/{sessionId}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-auth-sessions--sessionId-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-auth-sessions--sessionId-"
                    onclick="tryItOut('DELETEapi-v1-auth-sessions--sessionId-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-auth-sessions--sessionId-"
                    onclick="cancelTryOut('DELETEapi-v1-auth-sessions--sessionId-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-auth-sessions--sessionId-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-red">DELETE</small>
            <b><code>api/v1/auth/sessions/{sessionId}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-auth-sessions--sessionId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-auth-sessions--sessionId-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="sessionId"                data-endpoint="DELETEapi-v1-auth-sessions--sessionId-"
               value="architecto"
               data-component="url">
    <br>
<p>Example: <code>architecto</code></p>
...
<p>Example: <code>application/json</code></p>
                                ...
                                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>mfa_token</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="mfa_token"                data-endpoint="POSTapi-v1-auth-mfa-verify"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-auth-mfa-verify"
               value="ngzmiy"
               data-component="body">
    <br>
<p>Must be 6 characters. Example: <code>ngzmiy</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-mfa-verify-backup">POST api/v1/auth/mfa/verify-backup</h2>
...
<span id="example-requests-POSTapi-v1-auth-mfa-verify-backup">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/auth/mfa/verify-backup" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"mfa_token\": \"architecto\",
...
<span id="example-responses-POSTapi-v1-auth-mfa-verify-backup">
</span>
<span id="execution-results-POSTapi-v1-auth-mfa-verify-backup" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-auth-mfa-verify-backup"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-auth-mfa-verify-backup"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-auth-mfa-verify-backup" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-auth-mfa-verify-backup">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-auth-mfa-verify-backup" data-method="POST"
      data-path="api/v1/auth/mfa/verify-backup"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-auth-mfa-verify-backup', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-auth-mfa-verify-backup"
                    onclick="tryItOut('POSTapi-v1-auth-mfa-verify-backup');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-auth-mfa-verify-backup"
                    onclick="cancelTryOut('POSTapi-v1-auth-mfa-verify-backup');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-auth-mfa-verify-backup"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/auth/mfa/verify-backup</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-auth-mfa-verify-backup"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-auth-mfa-verify-backup"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="mfa_token"                data-endpoint="POSTapi-v1-auth-mfa-verify-backup"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-auth-mfa-verify-backup"
               value="ngzmiy"
               data-component="body">
    <br>
<p>Must be 6 characters. Example: <code>ngzmiy</code></p>
...
referrer-policy: strict-origin-when-cross-origin
permissions-policy: accelerometer=(), camera=(), geolocation=(), gyroscope=(), magnetometer=(), microphone=(), payment=(), usb=()
x-trace-id: 019ee5a3-60f6-7123-ab4f-b439f20854df
access-control-allow-origin: *
 </code></pre></details>         <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        &quot;status&quot;: &quot;healthy&quot;,
        &quot;timestamp&quot;: &quot;2026-06-20T15:25:50Z&quot;,
        &quot;checks&quot;: {
            &quot;database&quot;: {
                &quot;healthy&quot;: true,
                &quot;message&quot;: &quot;Connected&quot;
    ...
    &quot;meta&quot;: {
        &quot;trace_id&quot;: &quot;91b5465e-b461-4897-ab0e-9f9b3b0d69f5&quot;
    }
}</code>
 </pre>
    </span>
